...
`),n=[],r=null,i=null,a=-1;function o(){i!==null&&(r===null?n.push(i):r.items.push(i),i=null,a=-1)}function s(){r!==null&&(n.push(r),r=null)}function c(e){r===null?n.push(e):r.items.push(e)}for(let e of t){let t=e.length-e.trimStart().length,n=e.trim();if(!n)continue;if(n.startsWith(`## `)){o(),s();let[e,t]=k(n.slice(3).trim());r={name:e,items:[],indentLevel:0,comment:t,type:`section`};continue}let l=he(e,t);if(l)i&&t>a?i.links.push(l):(o(),c(l));else if(n.startsWith(`- `)){o();let[e,r]=k(n.slice(2).trim());i={name:e,links:[],indentLevel:t,comment:r,type:`group`},a=t}}return o(),s(),{items:n}}var _e=[`mailto:`,`tel:`,`about:`];function ve(e){return e.includes(`://`)||_e.some(t=>e.startsWith(t))}function ye(e){let t=5381;for(let n=0;n<e.length;n++)t=(t<<5)+t+e.charCodeAt(n)>>>0;return t.toString(16).padStart(8,`0`)}function be(e){let t=[],n=[];function r(){n.length>0&&(t.push({links:[...n],type:`link_group`}),n=[])}for(let i of e)i.type===`link`?n.push(i):(r(),t.push(i));return r(),t}function xe(e){let t=ve(e.url),n;n=e.target?e.target:t?ye(e.url):`_self`;let r=e.text??e.url,i=null;return t&&(e.url.startsWith(`http://`)||e.url.startsWith(`https://`))&&(i=n),{url:e.url,text:r,target:n,rawHtml:e.rawHtml,comment:e.comment,urlHash:i,type:`link`}}function Se(e){let t=e.links.map(xe);return{name:e.name,links:t,comment:e.comment,type:`group`}}function Ce(e){let t=[];for(let n of e)if(n.type===`section`){let e=Ce(n.items);t.push({name:n.name,items:e,comment:n.comment,type:`section`})}else n.type===`group`?t.push(Se(n)):t.push(xe(n));return be(t)}function we(e,t){return{title:t,items:Ce(e.items)}}function A(e){return e.replace(/[-_]/g,` `).replace(/\b\w/g,e=>e.toUpperCase())}function Te(e,t){return t.filter(t=>e?t.startsWith(e+`/`)&&!t.slice(e.length+1).includes(`/`):t!==``&&!t.includes(`/`)).sort()}function Ee(e){if(!e)return[];let t=e.split(`/`),n=[];for(let e=0;e<t.length-1;e++){let r=t.slice(0,e+1).join(`/`);n.push({name:A(t[e]),hash:`#/${r}`})}return n}function j(e,t,...n){let r=document.createElement(e);if(t)for(let[e,n]of Object.entries(t))r.setAttribute(e,n);for(let e of n)typeof e==`string`?r.appendChild(document.createTextNode(e)):r.appendChild(e);return r}function De(e){e.addEventListener(`click`,e=>{let t=e.target.closest(`.copy-btn`);if(!t)return;let n=t.getAttribute(`data-url`);if(!n)return;let r=document.createElement(`a`);r.href=n,navigator.clipboard.writeText(r.href).then(()=>{t.textContent=`✅`,setTimeout(()=>{t.textContent=`📋`},1500)})})}function Oe(e){let t=j(`li`);if(e.rawHtml){let n=document.createElement(`span`);n.innerHTML=e.rawHtml,t.appendChild(n)}else e.urlHash&&t.appendChild(j(`img`,{src:``,alt:``,class:`link-favicon`,"data-link-url":e.url,"data-url-hash":e.urlHash})),t.appendChild(j(`a`,{href:e.url,target:e.target},e.text));return t.appendChild(j(`button`,{class:`copy-btn`,"data-url":e.url,title:`Copy URL`},`📋`)),e.comment&&t.appendChild(j(`span`,{class:`link-comment`},`ℹ `+e.comment)),t}function ke(e){let t=j(`div`,{class:`subgroup`}),n=j(`div`,{class:`subgroup-header`},e.name);e.comment&&n.appendChild(j(`span`,{class:`group-comment`},`ℹ `+e.comment)),t.appendChild(n);let r=j(`ul`,{class:`group-links`});for(let t of e.links)r.appendChild(Oe(t));return t.appendChild(r),t}function Ae(e){let t=j(`ul`,{class:`links`});for(let n of e.links)t.appendChild(Oe(n));return t}function je(e){let t=document.createElement(`details`);t.className=`section`,t.open=!0;let n=j(`summary`,{},e.name);e.comment&&n.appendChild(j(`span`,{class:`section-comment`},`ℹ `+e.comment)),t.appendChild(n);let r=j(`div`,{class:`section-content`});for(let t of e.items)r.appendChild(Me(t));return t.appendChild(r),t}function Me(e){switch(e.type){case`group`:return ke(e);case`link_group`:return Ae(e);case`section`:return je(e)}}function Ne(e,t){let n=Te(e,t);if(n.length===0)return null;let r=j(`div`,{class:`children-nav`});for(let e of n){let t=A(e.split(`/`).pop()),n=`#/${e}`,i=j(`span`,{class:`child-link-wrap`});i.appendChild(j(`a`,{href:n,class:`child-link`,target:`_self`},t)),i.appendChild(j(`button`,{class:`copy-btn child-copy-btn`,"data-url":n,title:`Copy URL`},`📋`)),r.appendChild(i)}return r}function Pe(e){let t=j(`h1`,{class:`breadcrumbs`});if(t.appendChild(j(`a`,{href:`#/`,class:`breadcrumb-link`,target:`_self`},`Metabrowse`)),e){let n=Ee(e);for(let e of n)t.appendChild(j(`span`,{class:`breadcrumb-separator`},`/`)),t.appendChild(j(`a`,{href:e.hash,class:`breadcrumb-link`,target:`_self`},e.name));let r=A(e.split(`/`).pop());t.appendChild(j(`span`,{class:`breadcrumb-separator`},`/`)),t.appendChild(j(`span`,{class:`breadcrumb-current`},r))}else t.innerHTML=``,t.appendChild(j(`span`,{class:`breadcrumb-current`},`Metabrowse`));return t}function Fe(e,t,n,r){e.innerHTML=``;let i=j(`div`,{class:`container`}),a=j(`div`,{class:`fixed-header`}),o=j(`div`,{class:`header-bar`});o.appendChild(Pe(n.dirPath));let s=j(`div`,{class:`header-actions`}),c=n.dirPath?`#/edit/${n.dirPath}`:`#/edit/`,l=j(`a`,{href:c,class:`edit-link`},`Edit`);l.addEventListener(`click`,e=>{e.preventDefault(),window.open(c,`_blank`)}),s.appendChild(l);let u=j(`button`,{class:`tree-btn`,title:`Manage tree (t)`},`Tree`);u.addEventListener(`click`,()=>{r.onTreePanel?.()}),s.appendChild(u);let d=j(`button`,{class:`logs-btn`,title:`View debug logs`},`Logs`);d.addEventListener(`click`,()=>{document.body.appendChild(oe())}),s.appendChild(d),o.appendChild(s),a.appendChild(o);let f=j(`div`,{class:`search-bar`,role:`search`});f.appendChild(j(`span`,{class:`search-icon`},`🔍`)),f.appendChild(j(`input`,{type:`text`,id:`unified-search`,class:`search-input`,placeholder:`/ (this page) | ^K (global)`,"aria-label":`Search`}));let p=j(`button`,{type:`button`,id:`clear-search-btn`,class:`clear-search-btn`,title:`Clear search`,style:`display:none`},`×`);f.appendChild(p);let m=j(`label`,{class:`search-mode-toggle`}),h=j(`input`,{type:`checkbox`,id:`global-mode-checkbox`});h.checked=!0,m.appendChild(h),m.appendChild(j(`span`,{},`Global`)),f.appendChild(m),a.appendChild(f),i.appendChild(a);let g=j(`div`,{class:`scrollable-content`}),_=j(`div`,{id:`search-results-panel`,class:`search-results-panel`,style:`display:none`});_.appendChild(j(`div`,{id:`search-results-content`,class:`search-results`})),g.appendChild(_);let v=Ne(n.dirPath,r.contentPaths);v&&g.appendChild(v);for(let e of t.items)g.appendChild(Me(e));i.appendChild(g),e.appendChild(i);let y=document.createElement(`footer`);y.className=`shortcut-help`,y.innerHTML=[`<kbd>t</kbd> Tree`,`<kbd>e</kbd> Edit`,`<kbd>/</kbd> Search page`,`<kbd>Ctrl+K</kbd> Search all`,`<kbd>c</kbd> Collapse/restore`,`<kbd>r</kbd> Reload`].join(`<span class="shortcut-sep">|</span>`),e.appendChild(y),De(e)}var M=`metabrowse-fav-`,Ie=1440*60*1e3,Le=[`/favicon.ico`,`/favicon.png`,`/favicon.svg`];function Re(e){try{let t=localStorage.getItem(M+e);if(!t)return null;let n=JSON.parse(t);return n.failed?Date.now()-n.ts>Ie?(localStorage.removeItem(M+e),null):`FAILED`:n.path??null}catch{return null}}function ze(e,t){try{localStorage.setItem(M+e,JSON.stringify({path:t,ts:Date.now()}))}catch{}}function Be(e){try{localStorage.setItem(M+e,JSON.stringify({failed:!0,ts:Date.now()}))}catch{}}function Ve(e,t){let n=`https://icons.duckduckgo.com/ip3/`+t+`.ico`;e.onerror=()=>{e.style.display=`none`,Be(t)},e.onload=()=>{ze(t,`ddg`)},e.src=n}function He(e,t,n,r){if(r>=Le.length){Ve(e,n);return}let i=Le[r];e.onerror=()=>{He(e,t,n,r+1)},e.onload=()=>{ze(n,i)},e.src=t+i}function Ue(e){let t=e.querySelectorAll(`.link-favicon[data-url-hash]`);for(let e of t){let t=e.getAttribute(`data-link-url`);if(!t)continue;let n,r;try{let e=new URL(t);n=e.origin,r=e.hostname}catch{e.style.display=`none`;continue}let i=Re(r);if(i===`FAILED`){e.style.display=`none`;continue}if(i){e.onerror=()=>{e.style.display=`none`},e.src=i===`ddg`?`https://icons.duckduckgo.com/ip3/`+r+`.ico`:n+i;continue}He(e,n,r,0)}}function N(e){return e.replace(/[-_]/g,` `).replace(/\b\w/g,e=>e.toUpperCase())}function We(e){return e?`Metabrowse / `+e.split(`/`).map(N).join(` / `):`Metabrowse`}function Ge(e,t){let n=[];for(let r of e)if(r.type===`section`)n.push(...Ge(r.items,``));else if(r.type===`group`)for(let e of r.links)n.push({text:e.text,url:e.url,group:r.name,comment:e.comment??``});else if(r.type===`link_group`)for(let e of r.links)n.push({text:e.text,url:e.url,group:t,comment:e.comment??``});return n}function P(e,t){let n=[];for(let r of e)r.type===t&&n.push(r.name),r.type===`section`&&n.push(...P(r.items,t));return n}function Ke(e,t){return t.filter(t=>e?t.startsWith(e+`/`)&&!t.slice(e.length+1).includes(`/`):t!==``&&!t.includes(`/`))}function qe(e,t,n){let r=ge(t),i=e?N(e.split(`/`).pop()):`Home`,a=we(r,i);return{path:e?`#/${e}`:`#/`,title:i,breadcrumbs:We(e),links:Ge(a.items,``),groups:P(a.items,`group`),sections:P(a.items,`section`),children:Ke(e,n).map(e=>N(e.split(`/`).pop()))}}var Je=`metabrowse-search-mode`,Ye=`metabrowse-search-term`,F=null;function I(e){return(e.textContent??``).toLowerCase()}function Xe(e,t){let n=!1;for(let r of e.querySelectorAll(`:scope > li`)){let e=I(r).includes(t);e||r.querySelector(`a`)?.href?.toLowerCase().includes(t)&&(e=!0),r.style.display=e?``:`none`,e&&(n=!0)}return n}function Ze(e,t){let n=e.querySelector(`.subgroup-header`),r=n?I(n).includes(t):!1,i=e.querySelector(`.group-links`),a=!1;if(i)for(let e of i.querySelectorAll(`:scope > li`)){let n=I(e).includes(t);n||e.querySelector(`a`)?.href?.toLowerCase().includes(t)&&(n=!0),e.style.display=n||r?``:`none`,n&&(a=!0)}let o=r||a;return e.style.display=o?``:`none`,o}function L(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Qe(e,t){if(!t)return L(e);let n=e.toLowerCase().indexOf(t.toLowerCase());return n<0?L(e):L(e.substring(0,n))+`<mark>`+L(e.substring(n,n+t.length))+`</mark>`+L(e.substring(n+t.length))}function $e(e,t){F&&F();let n=document.getElementById(`unified-search`),r=document.getElementById(`global-mode-checkbox`),i=document.getElementById(`clear-search-btn`),a=document.getElementById(`search-results-panel`),o=document.getElementById(`search-results-content`);if(!n||!r)return;let s=e.querySelectorAll(`.children-nav .child-link-wrap`),c=e.querySelectorAll(`.section`),l=e.querySelectorAll(`.scrollable-content > .subgroup`),u=e.querySelectorAll(`.scrollable-content > .links`),d=Array.from(c,e=>e.open);function f(){i&&(i.style.display=n.value?``:`none`)}function p(){try{localStorage.setItem(Je,r.checked?`global`:`local`),localStorage.setItem(Ye,n.value)}catch{}}function m(){s.forEach(e=>{e.style.display=``}),c.forEach((e,t)=>{e.style.display=``,e.open=d[t],e.querySelectorAll(`.subgroup`).forEach(e=>{e.style.display=``,e.querySelectorAll(`.group-links > li`).forEach(e=>{e.style.display=``})}),e.querySelectorAll(`.links`).forEach(e=>{e.style.display=``,e.querySelectorAll(`:scope > li`).forEach(e=>{e.style.display=``})})}),l.forEach(e=>{e.style.display=``,e.querySelectorAll(`.group-links > li`).forEach(e=>{e.style.display=``})}),u.forEach(e=>{e.style.display=``,e.querySelectorAll(`:scope > li`).forEach(e=>{e.style.display=``})})}function h(){s.forEach(e=>{e.style.display=`none`}),c.forEach(e=>{e.style.display=`none`}),l.forEach(e=>{e.style.display=`none`}),u.forEach(e=>{e.style.display=`none`})}function g(e){if(a&&(a.style.display=`none`),!e){m();return}let t=e.toLowerCase();s.forEach(e=>{e.style.display=I(e).includes(t)?``:`none`}),c.forEach(e=>{let n=e.querySelector(`summary`),r=n?I(n).includes(t):!1,i=!1;e.querySelectorAll(`.section-content > .subgroup`).forEach(e=>{Ze(e,t)&&(i=!0)}),e.querySelectorAll(`.section-content > .links`).forEach(e=>{let n=Xe(e,t);e.style.display=n?``:`none`,n&&(i=!0)}),r||i?(e.style.display=``,e.open=!0):e.style.display=`none`}),l.forEach(e=>{Ze(e,t)}),u.forEach(e=>{let n=Xe(e,t);e.style.display=n?``:`none`})}function _(e){if(!e){a&&(a.style.display=`none`),m();return}a&&(a.style.display=``),h();let n=e.toLowerCase(),r=[],i=t();for(let e of i){e.breadcrumbs.toLowerCase().includes(n)&&r.push({page:e,type:`page`,text:e.breadcrumbs});for(let t of e.children)t.toLowerCase().includes(n)&&r.push({page:e,type:`child`,text:t});for(let t of e.sections)t.toLowerCase().includes(n)&&r.push({page:e,type:`section`,text:t});for(let t of e.groups)t.toLowerCase().includes(n)&&r.push({page:e,type:`group`,text:t});for(let t of e.links){let i=!1,a=t.text;t.text.toLowerCase().includes(n)?i=!0:t.url.toLowerCase().includes(n)?(i=!0,a=t.text+` — `+t.url):t.comment&&t.comment.toLowerCase().includes(n)&&(i=!0,a=t.text+` — `+t.comment),i&&r.push({page:e,type:`link`,text:a,link:t})}if(r.length>=50)break}if(!o)return;if(r.length===0){o.innerHTML=`<div class="search-no-results">No results found</div>`;return}let s=new Map,c=[];for(let e of r){let t=e.page.path;s.has(t)||(s.set(t,{page:e.page,items:[]}),c.push(t)),s.get(t).items.push(e)}let l=``;for(let t of c){let n=s.get(t);l+=`<div class="search-result-page">`,l+=`<a href="${L(n.page.path)}" class="search-result-page-link" target="_self">${Qe(n.page.breadcrumbs,e)}</a>`;for(let t of n.items){let r=t.type===`link`?`→`:t.type===`section`?`§`:t.type===`group`?`▸`:t.type===`child`?`◆`:`📄`,i=t.type===`link`&&t.link?t.link.url:n.page.path,a=t.type===`link`&&t.link?`_blank`:`_self`;l+=`<div class="search-result-item">`,l+=`<span class="search-result-type">${r}</span> `,l+=`<a href="${L(i)}" class="search-result-link" target="${a}">${Qe(t.text,e)}</a>`,l+=`</div>`}l+=`</div>`}o.innerHTML=l}function v(){let e=n.value.trim();f(),r.checked?_(e):g(e)}let y,b=()=>{clearTimeout(y),y=setTimeout(()=>{p(),v()},150)},x=()=>{p(),v()},S=()=>{n.value=``,p(),f(),v(),n.focus()};n.addEventListener(`input`,b),r.addEventListener(`change`,x),i&&i.addEventListener(`click`,S);try{let e=localStorage.getItem(Je),t=localStorage.getItem(Ye);e===`local`&&(r.checked=!1),t&&(n.value=t)}catch{}f(),v(),F=()=>{n.removeEventListener(`input`,b),r.removeEventListener(`change`,x),i&&i.removeEventListener(`click`,S),clearTimeout(y)}}var R=null;function z(){let e=document.activeElement?.tagName;return e===`INPUT`||e===`TEXTAREA`||e===`SELECT`}function et(e,t){R&&R();let n=e.querySelectorAll(`.section`),r=[],i=!1;function a(a){if(a.key===`t`&&!a.ctrlKey&&!a.metaKey&&!a.altKey){if(z())return;a.preventDefault(),t?.onTreePanel?.()}if(a.key===`/`&&!a.ctrlKey&&!a.metaKey&&!a.altKey){if(z())return;a.preventDefault();let e=document.getElementById(`global-mode-checkbox`),t=document.getElementById(`unified-search`);e&&(e.checked=!1),e&&e.dispatchEvent(new Event(`change`)),t&&(t.focus(),t.select())}if((a.ctrlKey||a.metaKey)&&a.key===`k`){a.preventDefault();let e=document.getElementById(`global-mode-checkbox`),t=document.getElementById(`unified-search`);e&&(e.checked=!e.checked,e.dispatchEvent(new Event(`change`))),t&&(t.focus(),t.select())}if(a.key===`e`&&!a.ctrlKey&&!a.metaKey&&!a.altKey){if(z())return;let t=e.querySelector(`.edit-link`);t&&(a.preventDefault(),t.click())}if(a.key===`r`&&!a.ctrlKey&&!a.metaKey&&!a.altKey){if(z())return;a.preventDefault(),location.reload()}if(a.key===`c`&&!a.ctrlKey&&!a.metaKey&&!a.altKey){if(z()||n.length===0)return;a.preventDefault(),i?(n.forEach((e,t)=>{e.open=t<r.length?r[t]:!0}),i=!1):(r=Array.from(n,e=>e.open),n.forEach(e=>{e.open=!1}),i=!0)}}document.addEventListener(`keydown`,a),R=()=>{document.removeEventListener(`keydown`,a)}}var tt=`modulepreload`,nt=function(e){return`/metabrowse/`+e},rt={},it=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=nt(t,n),t in rt)return;rt[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:tt,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},at=`https://stabledog.github.io/veditor.web/`,B=null,ot=!1;async function st(){if(B)return B;if(!ot){let e=document.createElement(`link`);e.rel=`stylesheet`,e.href=`${at}/veditor.css`,document.head.appendChild(e),ot=!0}B=await it(()=>import(`${at}/veditor.js`),[]);let e=document.getElementById(`version-badge`);return e&&B.VERSION&&!e.textContent?.includes(`ve`)&&(e.textContent+=` \u00b7 ve${B.VERSION}`),B}function V(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}async function ct(e,t,n,r,i,a){let o=a?`text/${a}/README.md`:`text/README.md`;e.innerHTML=`<div class="editor-loading">Loading editor...</div>`;let s,c,u;try{let[e,a]=await Promise.all([st(),l(t,n,r,i,o)]);s=e,c=a.content,u=a.sha}catch(t){e.innerHTML=`
  ...
  `,u.addEventListener(`click`,()=>n.remove()),l.appendChild(u),r.appendChild(l),n.appendChild(r);let d=H(e.contentPaths),f=0,p=null,m=null,h=null,g=null;function _(){s.innerHTML=``;let n=U(d);for(let r=0;r<n.length;r++){let i=n[r],a=document.createElement(`div`);a.className=`tree-node${r===f?` tree-node-selected`:``}`,a.setAttribute(`data-path`,i.dirPath),a.style.cssText=`
    ...
    `,r.appendChild(i),document.body.appendChild(r);let a=i.querySelector(`#drop-title`),o=i.querySelector(`#drop-url`),s=i.querySelector(`#drop-comment`),c=i.querySelector(`form`),l=i.querySelector(`.drop-modal-cancel`);a.focus(),a.select();function u(e){r.remove(),t(e)}c.addEventListener(`submit`,e=>{e.preventDefault();let t=a.value.trim(),n=o.value.trim();n&&u({title:t||n,url:n,comment:s.value.trim()})}),l.addEventListener(`click`,()=>u(null)),r.addEventListener(`click`,e=>{e.target===r&&u(null)}),r.addEventListener(`keydown`,e=>{e.key===`Escape`&&u(null)})})}function bt(e,t,n){let r=`- ${e} ${t}`;return n?`${r} # ${n}`:r}function xt(e){let t=[],n=new Set,r=/<a\s[^>]*href=["']([^"']+)["'][^>]*>([^<]*)<\/a>/gi,i;for(;(i=r.exec(e))!==null;){let e=i[1];n.has(e)||(n.add(e),t.push({text:i[2].trim()||e,url:e}))}let a=/https?:\/\/[^\s<>"')\]]+/g;for(;(i=a.exec(e))!==null;){let e=i[0].replace(/[.,;:!?)]+$/,``);if(!n.has(e)){n.add(e);let r=e;try{r=new URL(e).hostname.replace(/^www\./,``)}catch{}t.push({text:r,url:e})}}return t}function St(e,t){let n=e.split(`
...
`).find(e=>e&&!e.startsWith(`#`))?.trim();if(!e)return;let n=await yt(e);if(!n)return;await Ct([bt(n.title,n.url,n.comment)],t,`Drop`)}}),document.addEventListener(`paste`,async e=>{if(wt())return;let n=e.clipboardData?.getData(`text/plain`);if(!n)return;let r=xt(n);if(r.length===0){vt(`No links found in pasted text`);return}e.preventDefault(),await Ct(r.map(e=>`- ${e.url}`),t,`Paste`)})}function Et(e){return e.replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}var Dt=`notehub:token`,W=`notehub:host`,Ot=`metabrowse:owner`,kt=`metabrowse:repo`,G=document.getElementById(`app`),K=``,q=e,J=``,Y=``,X=[],Z=[],At=[];async function jt(){q=localStorage.getItem(W)||`github.com`,J=localStorage.getItem(Ot)||``,Y=localStorage.getItem(kt)||``;let e=localStorage.getItem(Dt);if(e&&J&&Y)try{D(`Auth: Attempting to validate token for host=${q}`),await i(q,e),D(`Auth: Authenticated`),K=e,await Nt()}catch(e){T(`Auth: Token validation failed: ${e instanceof Error?e.message:e}`),Mt()}else Mt()}function Mt(e){let t=localStorage.getItem(W)||`github.com`,n=localStorage.getItem(Ot)||``,r=localStorage.getItem(kt)||``;G.innerHTML=`
    <div class="auth-screen">
      <h1>metabrowse</h1>
      <p>Authenticate to access your links.</p>
      ${e?`<div class="error">${Q(e)}</div>`:``}
      <form id="auth-form">
        <label>GitHub Host
          <input type="text" id="host" value="${Lt(t)}" required />
        </label>
        <label>Content Owner
          <input type="text" id="owner" value="${Lt(n)}" placeholder="org-or-user" required />
        </label>
        <label>Content Repo
          <input type="text" id="repo" value="${Lt(r)}" placeholder="bb-metabrowse-links" required />
        </label>
  ...
  `,document.getElementById(`auth-form`).addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`host`).value.trim(),n=document.getElementById(`owner`).value.trim(),r=document.getElementById(`repo`).value.trim(),a=document.getElementById(`pat`).value.trim();try{D(`Auth: Attempting to validate token for host=${t}`),await i(t,a),D(`Auth: Authenticated`),localStorage.setItem(W,t),localStorage.setItem(Ot,n),localStorage.setItem(kt,r),localStorage.setItem(Dt,a),K=a,q=t,J=n,Y=r,await Nt()}catch(e){let t=e instanceof Error?e.message:String(e);T(`Auth: Token validation failed: ${t}`),Mt(`Authentication failed: ${t}`)}})}async function Nt(){G.innerHTML=`<div class="loading">Loading...</div>`,re(`Tree: Config: host=${q} owner=${J} repo=${Y}`);try{D(`Tree: Fetching directory tree for ${J}/${Y}`);let e=await a(q,K,J,Y);X=e,y(e)}catch(e){let t=v();if(t)X=t,E(`Tree: Using cached tree due to network error`);else{let t=String(e);T(`Tree: Failed to fetch tree: ${t}`),G.innerHTML=`<div class="error">Failed to load content tree: ${Q(t)}</div>`;return}}Z=o(X),D(`Tree: Loaded ${Z.length} pages indexed`),ue(Ft),Pt()}async function Pt(){D(`Search: Building index for ${Z.length} pages...`);let e=[],t=await Promise.allSettled(Z.map(async e=>{let t=e?`text/${e}/README.md`:`text/README.md`,n=b(t);return n||(n=await u(q,K,J,Y,t),x(t,n)),{dirPath:e,content:n}})),n=0;for(let r of t)r.status===`fulfilled`?e.push(qe(r.value.dirPath,r.value.content,Z)):n++;n>0&&E(`Search: Failed to index some pages (${n}/${Z.length})`),At=e,D(`Search: Search index built: ${e.length} pages indexed`)}async function Ft(e){if(e.kind===`edit`){D(`Edit: Opening editor for ${e.contentPath}`),await ct(G,q,K,J,Y,e.dirPath);return}if(e.dirPath&&!Z.includes(e.dirPath)){T(`Route: Page not found: ${e.dirPath}`),G.innerHTML=`<div class="error">Page not found: ${Q(e.dirPath)}</div>`;return}D(`Route: Navigating to #/${e.dirPath||``}`);let t=b(e.contentPath);t?(re(`Content: Using cached content for ${e.contentPath}`),It(e,t)):G.innerHTML=`<div class="loading">Loading ${Q(e.dirPath||`home`)}...</div>`;try{D(`Content: Fetching page ${e.dirPath||`home`} from ${e.contentPath}`);let n=await u(q,K,J,Y,e.contentPath);D(`Content: Loaded ${e.contentPath}`),x(e.contentPath,n),n!==t&&It(e,n)}catch(n){let r=n instanceof Error?n.message:String(n);t?E(`Content: Failed to refresh ${e.contentPath}, using cache`):(T(`Content: Failed to load ${e.contentPath}: ${r}`),G.innerHTML=`<div class="error">Failed to load: ${Q(r)}</div>`)}}function It(e,t){let n=we(ge(t),e.dirPath?e.dirPath.split(`/`).pop().replace(/[-_]/g,` `):`Home`),r=()=>{_t(Rt(),zt)};Fe(G,n,e,{contentPaths:Z,owner:J,repo:Y,host:q,onTreePanel:r}),Ue(G),$e(G,()=>At),et(G,{onTreePanel:r}),Tt(G,{host:q,token:K,owner:J,repo:Y,route:e,onSaved:()=>Ft(e)})}function Q(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Lt(e){return e.replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Rt(){return{token:K,host:q,owner:J,repo:Y,contentPaths:Z,tree:X}}async function zt(){let e=await a(q,K,J,Y);return X=e,y(e),Z=o(X),Pt(),Ft(ce(location.hash)),Z}var Bt=`0.2.0`,$=document.createElement(`span`);$.className=`version-badge`,$.id=`version-badge`,$.textContent=`v${Bt}`,document.body.appendChild($),jt();
//# sourceMappingURL=index-CmlEJiT1.js.map